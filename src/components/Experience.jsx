...
const Experience = () => {
  ...
  const [isVideoMindPresent, setIsVideoMindPresent] = useState(false);
  const [isQrImagePresent, setIsQrImagePresent] = useState(false);
  const [isNewConditionPresent, setIsNewConditionPresent] = useState(false); // New condition state
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        setIsVideoMindPresent("qr_code" in response.data);
        setIsTapToPlacePresent("tapToPlace" in response.data);
        setIsQrImagePresent("qr_image" in response.data);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  return (
    <div className="mt-10 ">
      ...
      {isTapToPlacePresent ? (
            ...
            <div className="mt-20 flex flex-col">
              <VerticalTimeline>
                ...
                <VerticalTimelineElement
                  ...
                  <div>
                    <div className="aspect-h-1 aspect-w-1 w-full h-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                      <img
                        src={data.TargetImageFile}
                        alt={data.TargetImageFile}
                    ...
                    <p
                      ...
                      captivating video, complemented by an immersive story,
        ...
        // Render components for the new condition
        <div>
          {" "}
          {data !== null && (
            <div className="mt-20 flex flex-col">
        ...
        // Render default content or handle absence of condition
