            ...
            <VerticalTimelineElement
              ...
              <div>
                ...
                <p
                  ...
                  effortlessly open the link in your browser for quick access.
                </p>
              </div>
            </VerticalTimelineElement>
            ...
            <VerticalTimelineElement
              ...
              <div>
                ...
                <p
                  className="text-secondary text-[16px] font-semibold p-6"
                  style={{ margin: 0 }}>
                  Upon opening the linked content through your camera, proceed
                  to scan the designated marker located above. As your camera
                  accurately identifies the marker, a captivating 3D model,
                  complemented by an immersive story, will seamlessly unfold
                  before you
                </p>
              </div>
            </VerticalTimelineElement>
