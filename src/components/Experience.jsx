...
const Experience = () => {
  ...
  const [VideoMindPresent, setIsVideoMindPresent] = useState(false);
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        setIsVideoMindPresent("mindfile" in response.data);
                    ...
                    <VerticalTimelineElement
                      ...
                      <div>
                        ...
                        <p
                          className="text-secondary text-[16px] font-semibold p-6"
                          style={{ margin: 0 }}>
                          Unlock your mobile phone's camera, scan the QR code,
                          and effortlessly open the link in your browser for
                          quick access.{" "}
                          <a
                            href={data.AR_Link}
                            target="_blank"
                    ...
                    <VerticalTimelineElement
                      ...
                      <div>
                        ...
                        <p
                          ...
                          proceed to scan the designated marker located above.
                          As your camera accurately identifies the marker, a
                    ...
                    <VerticalTimelineElement
                      ...
                      <div>
                        ...
                        <p
                          ...
                          proceed to scan the designated marker located above.
                          As your camera accurately identifies the marker, a
                          captivating 3D model, complemented by an immersive
                          story, will seamlessly unfold before you
                        </p>
                      </div>
                    </VerticalTimelineElement>
                  </VerticalTimeline>
