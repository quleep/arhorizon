      ...
      <div class="pages-content bg-blue-gray-50 mt-12">
        <div class="pages-content-container">
          <div class="pages-content-element">
            <p class="title">AR Ground Placement</p>
            <p class="paragraph">
              To place your AR content on the ground, simply tap the screen.
              Your scene will appear where you tap in the camera's field of
              view.
            </p>
            <p class="paragraph">
              This feature is supported on both Android and iOS devices. Ensure
              you have a clear view of the ground surface for optimal placement.
            </p>
          </div>
        </div>
        ...
        <hr />
        <p class="lead my-10">2. Choose from library</p>
        ...
        <div>
          <div class="row my-12">
            <p class="lead">3. Coupon & Discount (Optional)</p>
