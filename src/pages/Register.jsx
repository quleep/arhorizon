...
import { getToken, getUser, setUserSession, verifyToken } from '../service/Authservice';
...
const loginUrl= 'https://ymxx21tb7l.execute-api.ap-south-1.amazonaws.com/production/loginbrandarhorizon'
...
const handleInputChange = (e)=>{
 ...
 const handleloginsubmit = (e)=>{
   ...
   if(loginarray.email === ''){
    ...
    axios.post(loginUrl, requestBody).then(res=>{
...
<div>
  ...
  <button type="submit" onClick={handleloginsubmit} > {isloadinglogin ? <Loader/> : "Login"} </button>
...
const [registrationData, setRegistrationData] = useState({
  ...
  const handleRegistraion = async (e)=>{
    getId()
    const registerurl = 'https://ymxx21tb7l.execute-api.ap-south-1.amazonaws.com/production/registerbrandarhorizon'
    e.preventDefault()
...
<form onSubmit={handleRegistraion} className='registermainform' >
  <InputField label="Brandname" type="text" id="text" name = 'name' onChange={handleInputChange} value={registrationData.name} />
